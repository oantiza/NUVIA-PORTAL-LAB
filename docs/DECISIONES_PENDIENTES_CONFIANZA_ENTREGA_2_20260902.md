...
3. No cargar TradingView ni vídeos de YouTube antes de la elección o acción informada del usuario.
4. Autoalojar las tipografías del módulo de empresas y retirar la traducción directa mediante `translate.googleapis.com`, o documentar y contratar un mecanismo adecuado.
