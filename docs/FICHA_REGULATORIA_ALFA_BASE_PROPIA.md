...
4. **Universo completo (02-09-2026, noche).** Por decisión del fundador, el universo pasa de los 161 instrumentos marcados a **toda la lista de 725** (643 fondos, 8 ETF, 74 acciones, todos en euros). Se publican **698**: 9 no existen en EODHD, 4 no tienen precios válidos y 14 no tienen cotización reciente (fondos que dejaron de publicar valor liquidativo), todos excluidos por regla automática y anotados en `sync_runs`. El criterio sigue siendo de cobertura: la lista completa procede del mismo filtro por divisa que la selección inicial y no lleva mérito. Nada de lo anterior cambia la clasificación ni las decisiones 1–3.
