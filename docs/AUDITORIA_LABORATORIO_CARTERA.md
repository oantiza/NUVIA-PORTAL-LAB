...
|---|---|---|
| F1 | **23 apariciones de hexadecimal (15 valores distintos) fuera de `nuvia-tokens.css`**, todas del bloque: portada (4: `#d6d9d2` L4110, `#f7f3e7 #edf2e9 #e7ecf1` L4120), **tintes de correlación (3: `#cdd8c2 #e4e8e2 #ead9bd`, L4778–4780)**, tintes del solapamiento (3: `#a4b98a #cdd8c2 #e4e8e2`, L4989–4991), colores de continente del mapa (5: `#2e4f7c #4a5d23 #a04e2a #8a6a1f #256f6a`, L5086–5090) y neutros de tramo (`#e7e5da` ×2 L5092, `#f0eee3` ×6 L5094–5103). Los del mapa y solape duplican además valores que YA existen como token (`#4a5d23` = `--nv-green-700`). | Escáner estático sobre las 266 reglas |
| F1 bis | **Corrección de la propia auditoría (22-08):** la primera pasada dijo «20 hexadecimales» y su enumeración **omitía el trío `.nv-cor--alta/--media/--contraria`** (L4778–4780). `#ead9bd` es un 15.º valor que no aparecía en ninguna lista, y `#cdd8c2`/`#e4e8e2` están escritos dos veces cada uno (correlaciones y solapamiento) para decir lo mismo. P14 del plan debe cubrir también estas tres reglas. | Reescaneo L4090→fin de `nuvia-pages.css`, 20 líneas con hexadecimal dentro del bloque |
