...
| F2 | **Espaciados fuera de la escala de 8**: 20/34/15/30/26/18 px en la portada (~4144–4189), 6 px en peso-campo/filas/solape/leyenda (4508–5114), 10 px y 12 px en el informe (5132–5146). 13 valores en total. | Escáner estático (lista completa en el registro de la auditoría) |
