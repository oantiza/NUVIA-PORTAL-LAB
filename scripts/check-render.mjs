...
const CONTENIDO = {
  'index.html':            [['#mercados .home-section-banner__pill', 1], ['#patrimonio .home-section-banner__pill', 1], ['#familia-salud .home-section-banner__pill', 1], ['#academia .home-academia__cta', 1], ['#lecturas-con-criterio .home-lecturas__cta', 1]],
