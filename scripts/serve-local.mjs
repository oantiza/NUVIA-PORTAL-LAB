  ...
  try {
    ...
    response.writeHead(200, {
      ...
      ...(process.env.NUVIA_PREVIEW_OFFLINE === '1' ? {
        'Content-Security-Policy': "default-src 'self' data: blob:; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; connect-src 'self'; frame-src 'none'; form-action 'none'"
      } : {})
    });
